    ...
    createApp({
        setup() {
            ...
            const exportUrl = computed(() => {
                ...
                params.set('path', '/admin/visitor-activity');
            ...
            const paginationSummary = computed(() => {
                if (totalCount.value === 0) return 'No visitors to display';
                const from = (page.value - 1) * pageSize.value + 1;
                const to = Math.min(page.value * pageSize.value, totalCount.value);
                return 'Showing ' + from + '-' + to + ' of ' + totalCount.value + ' visitors';
            });
            ...
            function showDetail(visitor) {
                selectedVisitor.value = visitor;
                if (!modalInstance && detailModal.value) {
                    modalInstance = new bootstrap.Modal(detailModal.value);
                }
