...
func TestPageViewActivityControllerHandlerSuccess(t *testing.T) {
	...
	if !strings.Contains(layout.body, "page-view-activity-app") {
...
func TestPageViewActivityListAjax(t *testing.T) {
	store := newTestStore(t, true)
	...
	req := httptest.NewRequest(http.MethodPost, "/admin/page-view-activity", strings.NewReader(body))
