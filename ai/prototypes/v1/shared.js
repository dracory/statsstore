// Shared mock data and helpers for statsstore prototype v1

const SS = {
    navItems: [
        { title: 'Visitor Analytics', href: 'index.html', icon: 'bi-graph-up' },
        { title: 'Visitor Activity', href: 'visitor-activity.html', icon: 'bi-activity' },
        { title: 'Visitor Paths', href: 'visitor-paths.html', icon: 'bi-signpost-split' },
        { title: 'Page View Activity', href: 'page-view-activity.html', icon: 'bi-eye' },
    ...
    statCards: [
        ...
        { title: 'Returning Visits', value: '2,613', icon: 'bi-person-check', color: 'warning' },
